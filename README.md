...
- Settings: language, browser, game directory, port, where the game window opens (separate app window / browser tab) and resume-automatically (save the progress when the game closes, restore it next time); changes are saved automatically
