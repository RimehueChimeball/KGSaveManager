...
_ZH = {
    ...
    "msg.full_fallback": "浏览器已经在运行，无法进入全屏，已改为最大化。",
...
_EN = {
    ...
    "st.win_state_tab_hint": "A browser tab cannot resize its window, so the "
                             "window state applies to the separate window "
                             "(app mode) only.",
    "st.about": "About",
    ...
    "msg.full_fallback": "The browser was already running, so full screen was "
                         "not available; maximized instead.",
